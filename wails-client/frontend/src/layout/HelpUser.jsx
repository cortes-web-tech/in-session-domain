    ...
    <div className='chatboxWrapper'>
      ...
      <h2>{room} Help Chat</h2>
        <div className='chatboxText'>        
          ...
          [6:38:22] - [{room}] Tech: Thank you<br/><br/>
          ...
          [6:41:22] - [{room}] Tech: Yes, can we use that instead?<br/><br/>
          [6:42:48] - [Support] Operator: Yup! Click on the desktop icon and you'll access the file viewer menu, with the desktop as the source. Then select your USB drive, the file, and open it from there.<br/><br/>
